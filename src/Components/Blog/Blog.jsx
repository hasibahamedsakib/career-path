  ...
  return (
    <div className="container grid gap-6">
      <div className="bg-slate-100 p-6 rounded-lg">
        <h1 className="text-3xl my-4">1.When Should You Used Context Api ?</h1>
        <p className="my-3 text-gray-700 font-semibold">
          ...
          they may increase your build size and compromise your app performance.
          Context API is a React built-in feature, so we don’t have to worry
          about performance overhead and library installing issues. The props
          drilling problem occurs when you pass a prop somewhere down the tree.
          When a project grows, data passing through props becomes chaotic,
          making the code more vulnerable and complex. To tackle this problem,
          we use Context API.
        </p>
      </div>
      <div className="bg-slate-100 p-6 rounded-lg">
        ...
        <p className="my-3 text-gray-700 font-semibold">
          ...
          software developer can choose what argument the custom hook has and
          what should the argument return. --A custom hook always starts with
          the name ‘use’.
        </p>
      </div>
      <div className="bg-slate-100 p-6 rounded-lg">
